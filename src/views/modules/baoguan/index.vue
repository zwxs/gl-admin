<template>
  <div class="mod-user">
    ...
    >
      ...
      <el-form-item>
        <el-select v-model="dataForm.noteType" clearable placeholder="提单号">
          <el-option
      ...
      <el-form-item>
        <el-select v-model="dataForm.noteType" clearable placeholder="进出口标志">
          <el-option
            v-for="item in fileType"
            :key="item.id"
            :label="item.title"
      ...
      <el-form-item>
        <el-select v-model="dataForm.noteType" clearable placeholder="收发货人">
          <el-option
            v-for="item in fileType"
            :key="item.id"
            :label="item.title"
      ...
      <el-form-item>
        <el-select v-model="dataForm.noteType" clearable placeholder="查询删除数据">
          <el-option
            v-for="item in fileType"
            :key="item.id"
            :label="item.title"
